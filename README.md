# Opendbpy
This is a synchronized OpenROAD fork that supports OpenDB standalone operation as the Opendbpy library.

(Synchronization via [wei/pull](https://github.com/wei/pull).)
